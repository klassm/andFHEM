...
dependencies {
    ...
    implementation(group = "com.google.firebase", name = "firebase-ads", version = "20.2.0")
    ...
    implementation(group = "com.google.errorprone", name = "error_prone_annotations", version = "2.8.0")
    ...
    implementation(group = "com.google.firebase", name = "firebase-crashlytics", version = "18.2.0")
