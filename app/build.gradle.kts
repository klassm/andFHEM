...
buildscript {
    ...
    dependencies {
        ...
        classpath(group = "com.google.gms", name = "google-services", version = "4.3.14")
        classpath(group = "com.github.triplet.gradle", name = "play-publisher", version = "3.7.0")
        classpath(
            group = "org.jetbrains.kotlin",
        ...
        classpath(group = "com.google.firebase", name = "firebase-crashlytics-gradle", version = "2.9.2")
    }
}
...
dependencies {
    ...
    implementation(group = "com.google.firebase", name = "firebase-messaging", version = "23.1.0")
    implementation(group = "com.google.firebase", name = "firebase-ads", version = "20.6.0")
    implementation(group = "com.google.firebase", name = "firebase-perf", version = "20.2.0")
    ...
    implementation(group = "com.android.billingclient", name = "billing", version = "5.0.0")
    implementation(group = "com.android.billingclient", name = "billing-ktx", version = "5.0.0")
    ...
    implementation(group = "com.google.firebase", name = "firebase-crashlytics", version = "18.3.1")
    ...
    androidTestImplementation(group = "androidx.test", name = "runner", version = "1.5.0")
    androidTestImplementation(group = "androidx.test", name = "rules", version = "1.5.0")
    androidTestImplementation(group = "androidx.test.espresso", name = "espresso-core", version = "3.5.0")
    androidTestImplementation(group = "androidx.test.espresso", name = "espresso-contrib", version = "3.5.0")
}
