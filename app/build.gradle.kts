...
buildscript {
    ...
    dependencies {
        ...
        classpath(group = "com.google.firebase", name = "firebase-crashlytics-gradle", version = "2.8.0")
    }
}
...
dependencies {
    ...
    implementation(group = "com.google.http-client", name = "google-http-client-android", version = "1.40.1") {
    ...
    implementation(group = "com.google.firebase", name = "firebase-crashlytics", version = "18.2.4")
