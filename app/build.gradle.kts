...
buildscript {
    ...
    dependencies {
        ...
        classpath(group = "androidx.navigation", name = "navigation-safe-args-gradle-plugin", version = "2.3.4")
        classpath(group = "com.google.firebase", name = "perf-plugin", version = "1.3.5")
        classpath(group = "com.google.firebase", name = "firebase-crashlytics-gradle", version = "2.5.2")
    }
}
...
dependencies {
    ...
    implementation(group = "com.google.firebase", name = "firebase-perf", version = "19.1.1")
    implementation(group = "com.google.android.material", name = "material", version = "1.3.0")
    implementation(group = "com.google.code.gson", name = "gson", version = "2.8.6")
    implementation(group = "com.google.http-client", name = "google-http-client-android", version = "1.39.1") {
    ...
    implementation(group = "androidx.fragment", name = "fragment-ktx", version = "1.3.2")
    ...
    implementation(group = "com.google.firebase", name = "firebase-crashlytics", version = "17.4.1")
