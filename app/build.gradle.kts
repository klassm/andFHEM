...
dependencies {
    ...
    implementation(group = "com.google.firebase", name = "firebase-messaging", version = "23.2.1")
    implementation(group = "com.google.firebase", name = "firebase-ads", version = "20.6.0")
    implementation(group = "com.google.firebase", name = "firebase-perf", version = "20.4.1")
    ...
    implementation(group = "com.google.firebase", name = "firebase-crashlytics", version = "18.4.3")
