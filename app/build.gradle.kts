...
dependencies {
    ...
    implementation(group = "com.google.firebase", name = "firebase-ads", version = "20.3.0")
    implementation(group = "com.google.firebase", name = "firebase-perf", version = "20.0.2")
    implementation(group = "com.google.android.material", name = "material", version = "1.4.0")
    implementation(group = "com.google.code.gson", name = "gson", version = "2.8.8")
    implementation(group = "com.google.http-client", name = "google-http-client-android", version = "1.40.0") {
    ...
    implementation(group = "com.google.firebase", name = "firebase-crashlytics", version = "18.2.1")
