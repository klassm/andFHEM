...
dependencies {
    ...
    implementation(group = "com.google.firebase", name = "firebase-messaging", version = "23.0.2")
    ...
    implementation(group = "com.google.http-client", name = "google-http-client-android", version = "1.41.5") {
    ...
    implementation(group = "com.android.billingclient", name = "billing", version = "4.1.0")
    implementation(group = "com.android.billingclient", name = "billing-ktx", version = "4.1.0")
    ...
    implementation(group = "com.google.firebase", name = "firebase-crashlytics", version = "18.2.9")
