...
dependencies {
    ...
    implementation(group = "com.google.firebase", name = "firebase-messaging", version = "20.2.0")
    implementation(group = "com.google.firebase", name = "firebase-ads", version = "19.5.0")
    implementation(group = "com.google.firebase", name = "firebase-perf", version = "19.0.9")
    implementation(group = "com.google.android.material", name = "material", version = "1.2.1")
    implementation(group = "com.google.code.gson", name = "gson", version = "2.8.6")
    implementation(group = "com.google.http-client", name = "google-http-client-android", version = "1.37.0") {
    ...
    implementation(group = "net.lingala.zip4j", name = "zip4j", version = "2.6.0")
