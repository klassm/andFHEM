...
dependencies {
    ...
    implementation(group = "androidx.fragment", name = "fragment-ktx", version = "1.5.3")
    ...
    implementation(group = "joda-time", name = "joda-time", version = "2.12.0")
    ...
    implementation(group = "com.google.firebase", name = "firebase-crashlytics", version = "18.3.0")
