...
dependencies {
    ...
    implementation(group = "com.google.firebase", name = "firebase-crashlytics", version = "18.3.2")
    ...
    androidTestImplementation(group = "androidx.test", name = "runner", version = "1.5.1")
