...
buildscript {
    ...
    dependencies {
        ...
        classpath(group = "com.github.triplet.gradle", name = "play-publisher", version = "3.8.6")
        classpath(
            group = "org.jetbrains.kotlin",
        ...
        classpath(group = "com.google.firebase", name = "firebase-crashlytics-gradle", version = "2.9.9")
    }
}
...
dependencies {
    ...
    implementation(group = "com.google.firebase", name = "firebase-messaging", version = "23.3.1")
    implementation(group = "com.google.firebase", name = "firebase-ads", version = "20.6.0")
    implementation(group = "com.google.firebase", name = "firebase-perf", version = "20.5.1")
    ...
    implementation(group = "com.android.billingclient", name = "billing", version = "6.1.0")
    implementation(group = "com.android.billingclient", name = "billing-ktx", version = "6.1.0")
    ...
    implementation(group = "androidx.annotation", name = "annotation", version = "1.7.0")
    ...
    implementation(group = "com.google.firebase", name = "firebase-crashlytics", version = "18.6.0")

    implementation(group = "org.jetbrains.kotlin", name = "kotlin-stdlib-jdk7", version = kotlinVersion)
    implementation(group = "org.jetbrains.kotlinx", name = "kotlinx-serialization-json", version = "1.6.1")
    ...
    testImplementation(group = "io.mockk", name = "mockk", version = "1.13.8")
