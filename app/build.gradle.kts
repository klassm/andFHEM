...
buildscript {
    ...
    dependencies {
        ...
        classpath(group = "com.google.gms", name = "google-services", version = "4.3.12")
        ...
        classpath(group = "com.google.firebase", name = "firebase-crashlytics-gradle", version = "2.9.1")
    }
}
...
dependencies {
    ...
    implementation(group = "com.google.firebase", name = "firebase-messaging", version = "23.0.6")
    ...
    implementation(group = "com.google.http-client", name = "google-http-client-android", version = "1.42.0") {
    ...
    implementation(group = "net.lingala.zip4j", name = "zip4j", version = "2.11.0")
    ...
    implementation(group = "com.google.firebase", name = "firebase-crashlytics", version = "18.2.11")
