...
buildscript {
    ...
    dependencies {
        ...
        classpath(group = "com.google.firebase", name = "firebase-crashlytics-gradle", version = "2.7.0")
    }
}
...
dependencies {
    ...
    implementation(group = "androidx.fragment", name = "fragment-ktx", version = "1.3.4")
    ...
    implementation(group = "com.google.firebase", name = "firebase-crashlytics", version = "18.0.1")
