...
buildscript {
    ...
    dependencies {
        ...
        classpath(group = "com.github.triplet.gradle", name = "play-publisher", version = "3.5.0")
...
dependencies {
    ...
    implementation(group = "com.google.firebase", name = "firebase-crashlytics", version = "18.1.0")
