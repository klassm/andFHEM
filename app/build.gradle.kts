...
buildscript {
    ...
    dependencies {
        ...
        classpath(group = "com.github.triplet.gradle", name = "play-publisher", version = "3.2.0")
...
dependencies {
    ...
    implementation(group = "com.google.firebase", name = "firebase-perf", version = "19.0.11")
    implementation(group = "com.google.android.material", name = "material", version = "1.2.1")
    implementation(group = "com.google.code.gson", name = "gson", version = "2.8.6")
    implementation(group = "com.google.http-client", name = "google-http-client-android", version = "1.38.0") {
    ...
    implementation(group = "com.google.errorprone", name = "error_prone_annotations", version = "2.5.0")
    ...
    implementation(group = "androidx.fragment", name = "fragment-ktx", version = "1.2.5")
    ...
    implementation(group = "com.google.firebase", name = "firebase-crashlytics", version = "17.3.0")
    ...
    testImplementation(group = "io.mockk", name = "mockk", version = "1.10.4")
