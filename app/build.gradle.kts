...
val androidXNavigationVersion = "2.7.4"
...
dependencies {
    ...
    implementation(group = "com.google.firebase", name = "firebase-messaging", version = "23.3.0")
    ...
    implementation(group = "androidx.fragment", name = "fragment-ktx", version = "1.6.1")
    ...
    implementation(group = "com.google.firebase", name = "firebase-crashlytics", version = "18.5.0")
