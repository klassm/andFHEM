...
dependencies {
    ...
    implementation(group = "androidx.fragment", name = "fragment-ktx", version = "1.7.0")
    ...
    implementation(group = "com.google.firebase", name = "firebase-crashlytics", version = "18.6.4")
