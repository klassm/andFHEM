...
dependencies {
    ...
    implementation(group = "com.google.firebase", name = "firebase-messaging", version = "23.0.7")
    ...
    implementation(group = "com.google.firebase", name = "firebase-crashlytics", version = "18.2.12")
