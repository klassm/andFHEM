...
dependencies {
    ...
    implementation(group = "com.google.firebase", name = "firebase-ads", version = "19.7.0")
    ...
    implementation(group = "com.google.http-client", name = "google-http-client-android", version = "1.39.0") {
    ...
    implementation(group = "androidx.fragment", name = "fragment-ktx", version = "1.3.1")
    ...
    implementation(group = "com.google.firebase", name = "firebase-crashlytics", version = "17.4.0")
