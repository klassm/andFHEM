...
class MediumWeatherForecastWidget : DeviceAppWidgetView() {
    ...
    override fun fillWidgetView(context: Context, view: RemoteViews, device: FhemDevice, widgetConfiguration: WidgetConfiguration) {
        ...
        val forecasts = weatherDevice.forecasts
    ...
    override fun supports(device: FhemDevice, context: Context): Boolean = device is WeatherDevice
