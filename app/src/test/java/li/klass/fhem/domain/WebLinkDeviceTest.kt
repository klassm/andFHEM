...
class WebLinkDeviceTest : DeviceXMLParsingBase() {
    ...
    fun testForCorrectlySetAttributes() {
        ...
        assertThat(internalValueFor(device, "LINK")).isEqualTo("http://www.sbazv.de/frames/termin_2013/hm4.php?ortnr=184&strnr=100")
    }

    override fun getFileName(): String = "webLink.xml"
}
