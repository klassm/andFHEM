...
public class BMP180DeviceTest extends DeviceXMLParsingBase {
    ...
    public void all_properties_read() {
        ...
        assertThat(device.getPressure()).isEqualTo("1006.3 (hPa)");
        assertThat(device.getPressureNN()).isEqualTo("1019.5 (hPa)");
        assertThat(device.getTemperature()).isEqualTo("21.9 (°C)");
    }
