...
public class TouchImageView extends ImageView {
    ...
    private OnTouchImageViewChangeListener listener;
    ...
    public void setListener(OnTouchImageViewChangeListener listener) {
        this.listener = listener;
    }

    public void manualTouch() {
        MotionEvent motionEvent = MotionEvent.obtain(100, 100, MotionEvent.ACTION_UP, 0, 0, 0);
    ...
    private void sharedConstructing(Context context) {
        ...
        setOnTouchListener(new OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (listener != null) {
                    listener.onTouchImageViewChange(saveScale, x, y);
                }
