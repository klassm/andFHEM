...
import static li.klass.fhem.constants.BundleExtraKeys.CONNECTION_REMOTE_URL;
...
public class ConnectionsIntentService extends ConvenientIntentService {
    ...
    protected STATE handleIntent(Intent intent, long updatePeriod, ResultReceiver resultReceiver) {
        ...
        if (Actions.CONNECTIONS_LIST.equals(action)) {
            ...
            String remoteUrl = intent.getStringExtra(CONNECTION_REMOTE_URL);
            ...
            if (Actions.CONNECTION_CREATE.equals(action)) {
                connectionService.create(name, serverType, username,
                        password, ip, port, url, remoteUrl, clientCertificatePath, clientCertificatePassword, this);
            } else {
                connectionService.update(id, name, serverType, username, password, ip,
                        port, url, remoteUrl, clientCertificatePath, clientCertificatePassword, this);
            }
