...
import li.klass.fhem.behavior.dim.DimmableBehavior.isDimDisabled
...
constructor(deviceGroupProviders: DeviceGroupProviders) {
    ...
    fun functionalityFor(device: FhemDevice, context: Context): String {
        ...
        } else if (device.deviceConfiguration.isPresent) {
            functionality = DeviceFunctionality.valueOf(device.deviceConfiguration.get().defaultGroup)
        }
