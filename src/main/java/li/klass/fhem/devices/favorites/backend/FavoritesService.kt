...
package li.klass.fhem.devices.favorites.backend
...
constructor(val roomListService: RoomListService,
    ...
    fun getFavorites(context: Context): RoomDeviceList {
        ...
        favoritesList.hiddenGroups = allRoomsDeviceList.hiddenGroups
        favoritesList.hiddenRooms = allRoomsDeviceList.hiddenRooms
