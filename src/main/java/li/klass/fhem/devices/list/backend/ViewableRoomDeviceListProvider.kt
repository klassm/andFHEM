...
class ViewableRoomDeviceListProvider @Inject constructor(
    ...
    fun provideFor(roomDeviceList: RoomDeviceList): List<ViewableElementsCalculator.Element> {
        val filteredDeviceList = fhemWebConfigurationService.filterHiddenGroupsFrom(context, roomDeviceList)

        return viewableElementsCalculator.calculateElements(context, filteredDeviceList)
    }
}