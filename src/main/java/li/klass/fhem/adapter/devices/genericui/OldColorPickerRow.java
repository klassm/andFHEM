...
@Deprecated
public class OldColorPickerRow implements ColorPickerListener {
    private final int originalValue;
    private int value;
    private int alertDialogTitle;

    public OldColorPickerRow(int value, int alertDialogTitle) {
    ...
    private void showColorPicker(LayoutInflater inflater, Context context, final View colorValueView) {
