...
public class ConnectionEditAndroidTest extends ActivityInstrumentationTestCase2<AndFHEMMainActivity> {
    ...
    public void testBlablub() throws Exception {
        AndFHEMMainActivity activity = getActivity();
        ...
        Button button = (Button) activity.findViewById(R.id.create);

//        while((button = (Button) activity.findViewById(R.id.create)) == null) {
//            getInstrumentation().waitForIdleSync();
//        }
